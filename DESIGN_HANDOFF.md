...
- **Demo passwords visible** in seed JSON files (`backend/demo_accounts.json`, `backend/demo_citizen_accounts.json`). Visible-in-UI passwords are part of the demo flow ("Shared demo password: CivicLensVoter!2026"). Production removes both files.
...
**Demo credentials:**
- Rep accounts (any of these, password `CivicLensDemo!2026`):
...
- Citizen accounts (60, password `CivicLensVoter!2026`):
